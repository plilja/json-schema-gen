 ...
 * path with {@link JsonSchemaGenerator#withProducer(String, ValueProducer)}
 * and invoked afresh on every {@link JsonSchemaGenerator#generate()} that
...
public interface ValueProducer {
     ...
     * {@link JsonSchemaGenerator#generate()} call.
     */
    Object produce();
}
